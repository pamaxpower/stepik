...
# сортировка по значениям (отсортированный по возрастанию кортеж)
for key, value in sorted(capitals.items(), key = lambda x: x[1]):
    print(value)

print()

# сортировка по ключам (отсортированный по возрастанию список)
...
Примечание. Имена необходимо вывести на одной строке, 
